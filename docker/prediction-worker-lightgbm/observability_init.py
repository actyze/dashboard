"""Initialize observability for prediction-worker-lightgbm."""
...
def configure_observability(service_name: str = "prediction-worker-lightgbm", log_level: str = "INFO"):
...
def setup_health_endpoints(app, service_name: str = "prediction-worker-lightgbm") -> None:
