...
const LicenseCheckDialog = ({ onLicenseAdded, onClose, embedded = false }) => {
  ...
  // Dialog content - shared between embedded and standalone modes
  const dialogContent = (
    <div 
  ...
  // If embedded, just return the dialog content (parent handles positioning)
  if (embedded) {
    return dialogContent;
  }

  // Standalone mode - include backdrop and centering
  return (
